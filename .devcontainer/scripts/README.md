...
- Checks required variables (PROJECT_NAME, HOST_USERNAME, HOST_UID, HOST_GID, CONTAINER_HOSTNAME, CONTAINER_MEMORY, CONTAINER_CPUS, CONTAINER_SHM_SIZE, GIT_USER_NAME, GIT_USER_EMAIL, EDITOR_CHOICE, DOCKER_IMAGE_NAME, DOCKER_IMAGE_TAG, ANSIBLE_CORE_VERSION, ANSIBLE_LINT_VERSION, YAMLLINT_VERSION)
